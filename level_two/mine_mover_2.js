...
import * as exp_funcs from './explosion_functions_2.js';
...
let new_mine_number_generator = () => {
    ...
    if (module_score_level_one >= 6000) {
        gq_l_m_3.pause == true;
...
let level_finish = (module_score_level_two, collision_count_nose_level_two, collision_count_wing_level_two) => {
