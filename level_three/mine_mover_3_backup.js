...
let mine_mover_3_counter = 0;


let mine_mover_3 = () => {
    mine_mover_3_counter += 1;
    ...
    if (gq_l_m_3.pause == false
        ...
        if (
            ...
            module_score += 600;
            score_update.score_update_higher_levels(module_score, collision_count_nose, collision_count_wing);
            ...
            cancelAnimationFrame(mine_mover_3);
            new_mine_number_generator();
            return;
        }
    ...
    requestAnimationFrame(mine_mover_3);
...
let new_mine_number_generator = () => {
    ...
    if (module_score > 1000) {
        level_finish(module_score, collision_count_nose, collision_count_wing);
    }
...
let level_finish = (module_score, collision_count_nose, collision_count_wing) => {
    ...
    //sessionStorage.getItem("level_one_stored_score")
    $("#SD_score_par").hide();
