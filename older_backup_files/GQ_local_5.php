    ...
    <div id="colmiddle1">
        ...
        <script type="module">
            ...
            let blue_mine = () => {
                ...
                var intersects_blue = box1.intersectsBox(blue_mine_box);
            ...
            let green_mine = () => {
                ...
                var intersects_green = box1.intersectsBox(green_mine_box);
                // var intersects_green = box1.intersect(green_mine_box);


                if (mine_green.position.z >= 6.5 && !intersects) {
            ...
            let red_mine = () => {
                ...
                var intersects_red = box1.intersectsBox(red_mine_box);
                //var intersects_red = box1.intersect(red_mine_box);

                if (mine_red.position.z >= 6.5) {
            ...
            document.querySelector("#stop1").addEventListener('click', function() {
                // z_pos_when_stopped = mine_blue.position.z;
