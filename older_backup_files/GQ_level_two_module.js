...
const vertices = [
    // front
    { pos: [-2, -0.1, 1], norm: [0, 0, 1], uv: [0, 0], }, // 0
    { pos: [2.5, -0.1, 1], norm: [0, 0, 1], uv: [1, 0], }, // 1
    { pos: [-2, 0.1, 1], norm: [0, 0, 1], uv: [0, 1], }, // 2
    { pos: [2.5, 0.1, 1], norm: [0, 0, 1], uv: [1, 1], }, // 3
    // right
    // { pos: [2.5, -0.1, 3], norm: [1, 0, 0], uv: [0, 0], }, // 4
    // { pos: [2.5, -0.1, -1], norm: [1, 0, 0], uv: [1, 0], }, // 5
    // { pos: [2.5, 0.1, 3], norm: [1, 0, 0], uv: [0, 1], }, // 6
    // { pos: [2.5, 0.1, -1], norm: [1, 0, 0], uv: [1, 1], }, // 7
    // // back
    ...
    // // left
    // { pos: [-2, -0.1, -1], norm: [-1, 0, 0], uv: [0, 0], }, // 12
    // { pos: [-2, -0.1, 3], norm: [-1, 0, 0], uv: [1, 0], }, // 13
    // { pos: [-2, 0.1, -1], norm: [-1, 0, 0], uv: [0, 1], }, // 14
    // { pos: [-2, 0.1, 3], norm: [-1, 0, 0], uv: [1, 1], }, // 15
    // // top
    // { pos: [2.5, 0.1, -1], norm: [0, 1, 0], uv: [0, 0], }, // 16
    // { pos: [-2, 0.1, -1], norm: [0, 1, 0], uv: [1, 0], }, // 17
    // { pos: [2.5, 0.1, 3], norm: [0, 1, 0], uv: [0, 1], }, // 18
    // { pos: [-2, 0.1, 3], norm: [0, 1, 0], uv: [1, 1], }, // 19
    // // bottom
    // { pos: [2.5, -0.1, 3], norm: [0, -1, 0], uv: [0, 0], }, // 20
    // { pos: [-2, -0.1, 3], norm: [0, -1, 0], uv: [1, 0], }, // 21
    // { pos: [2.5, -0.1, -1], norm: [0, -1, 0], uv: [0, 1], }, // 22
    // { pos: [-2, -0.1, -1], norm: [0, -1, 0], uv: [1, 1], }, // 23
];
...
const WFgeometry = new THREE.SphereGeometry(3, 100, 100);

const wireframe = new THREE.WireframeGeometry(WFgeometry);

const WFline = new THREE.LineSegments(wireframe);
WFline.material.depthTest = true;
WFline.material.opacity = 0.0;
