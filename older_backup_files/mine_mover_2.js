...
// // mine mover 2 function area begins .....................................................
...
let mine_mover_2 = (time) => {
    ...
    // if (mines_i < 2) {
    // scene.add(mines_array[mines_i + 1])
    // } else  {
    //     scene.add(mines_array[(mines_i - 1)])
    // }
    ...
    if (mines_array[mines_i].position.z >= 7.5) {
        ...
        scene.remove(mines_array[mines_i + 1]);

        mines_array[mines_i].position.x = cubes[0].position.x;
        mines_array[mines_i].position.y = cubes[0].position.y;
        // mines_array[mines_i].position.x = protector_cylinders.position.x;
        // mines_array[mines_i].position.y = protector_cylinders.position.y;
        if (mines_i == 2) {
            mines_i = 0;
        } else {
            mines_i += 1;
        ...
        setTimeout(mine_move_control_2(), 0);
