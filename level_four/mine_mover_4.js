...
import * as gltf_loads from './gltf_loading_script_4.js';
import * as exp_funcs from './explosion_functions_4.js';
import * as icosa_loads from './icosa_hedron_4.js';
import * as score_update from './score_update_4.js';
import * as gq_l_m_3 from './GQ_level_four_module.js';
...
let mine_mover_2 = () => {
    ...
    if (gq_l_m_3.pause == false
        ...
        if (mine_number % 3 == 0) {
            ...
            gsap.to(
                [
                    gltf_loads.red_mines_array_2[mine_number].position,
                ],
                0.1,
                {
                    z: "+=3.2",
            ...
            gsap.to(
                [
                    gltf_loads.green_mines_array_2[mine_number].position,
                ],
                0.1,
                {
                    z: "+=3.2",
            ...
            gsap.to(
                [
                    gltf_loads.blue_mines_array_2[mine_number].position,
                ],
                0.1,
                {
                    z: "+=3.2",
        ...
        if (
            ...
            module_score_level_four += 6000;
            score_update.score_update(module_score_level_four, collision_count_nose, collision_count_wing);
...
let new_mine_number_generator = () => {
    ...
    if (module_score_level_four >= 18000) {
        gq_l_m_3.pause == true;
        level_finish(module_score_level_four, 
    ...
    if (gltf_loads.red_mines_array[mine_number]) {
        ...
        gq_l_m_3.pause == true;
        level_finish(module_score_level_four, collision_count_nose, collision_count_wing);
        return;
    } else {
        cancelAnimationFrame(mine_mover_2);
        new_mine_number_generator();
...
let level_finish = (module_score_level_four, collision_count_nose, collision_count_wing) => {
    let player;
    let level_one_stored_score_number = Number(sessionStorage.getItem("level_one_stored_score"));
    let level_two_stored_score_number = Number(sessionStorage.getItem("level_two_stored_score"));
    let level_three_stored_score_number = Number(sessionStorage.getItem("level_three_stored_score"));
    ...
    document.querySelector("#C_D_F_collision_count").innerHTML =
        document.querySelector("#C_D_F_collision_count").innerHTML =
        "<form><h1>Congratulations" + player + ", Tothian mine field inner double zone passed"
        + "<h3>Number of wing collisions (Inner double zone): " + collision_count_wing +
        "<br>Number of hull collisions (Inner double zone): " + collision_count_nose +
        "<br>Total score (Inner double zone): " + module_score_level_four + "<br>"

    + "<br> <h3>Number of wing collisions (Inner zone): " + sessionStorage.getItem("level_three_wing_collisions") +
    "<br>Number of hull collisions (Inner zone): " + sessionStorage.getItem("level_three_nose_collisions") +
    "<br>Total score (Inner zone): " + sessionStorage.getItem("level_three_stored_score") +

        "<h3>Number of wing collisions (Middle zone): " + sessionStorage.getItem("level_two_wing_collisions") +
        "<br>Number of hull collisions (Middle zone): " + sessionStorage.getItem("level_two_nose_collisions") +
        "<br>Total score (Middle zone): " + sessionStorage.getItem("level_two_stored_score") +
        ...
        "<br>Total score (Outer perimeter): " + sessionStorage.getItem("level_one_stored_score") +

    "<br>Running total: " + (module_score_level_four + level_three_stored_score_number + level_one_stored_score_number + level_two_stored_score_number)
        ;

    document.querySelector("#C_D_F_next_level").innerHTML =
        "<a href='../level_three/'><h3>Go to next level?</h3></a>";
