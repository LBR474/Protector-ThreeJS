...
<head>
    ...
    <script type="module" src="GQ_level_four_module.js"></script>
    <!-- <script type="module" src="gltf_loading_script_3.js"></script> -->
...
<body>
    <!-- <p id="demo_check_loading">Demo Check Loading</p> -->
    ...
    <div id="top_right_menu">
        ...
        <p id="trm_blurb">
            Use mouse to move the Protector <br>
    ...
    <div id="colmiddle1">
        ...
        <div id="score_div">
            ...
            <p id="SD_C_C_par"></p>
            <p id="SD_previous_level_score_par">
